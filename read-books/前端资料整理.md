...
-  System-design-101 是一个 GitHub 上的开源项目
...
- **`很棒的JavaScript库`**
  ...
  [sorrycc/awesome-javascript: 🐢 A collection of awesome browser-side JavaScript libraries, resources and shiny things. (github.com)](https://github.com/sorrycc/awesome-javascript)
...
- **`WTFJS`**
  ...
  [denysdovhan/wtfjs: 🤪 A list of funny and tricky JavaScript examples (github.com)](https://github.com/denysdovhan/wtfjs)
...
- *免费编程书籍*
  ...
  [justjavac/free-programming-books-zh_CN: :books: 免费的计算机编程类中文书籍，欢迎投稿 (github.com)](https://github.com/justjavac/free-programming-books-zh_CN)
...
- ### notepad--
  ...
  **项目地址：https://gitee.com/cxasm/notepad--**
...
- ### 墨干编辑器
  ...
  **项目地址：https://gitee.com/XmacsLabs/mogan**
...
- ### 思源笔记
  ...
  **项目地址：https://gitee.com/siyuan-note/siyuan**
